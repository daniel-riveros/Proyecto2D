...
public class MovWitcher : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!MenuFin.isGameOver)
        {
            ...
            if (stateInfo1.IsName("Witcher_Revive"))
            {
                if (contSound == 0)
                {
            ...
            if (!imDead && !imLiving)
            {
                ...
                else
                {
                    ...
                    if (cont < 2)
                    {
                        SoundManagerScript.PlaySound(S1);
                    }
                    else if (cont > max)
                    {
                        cont = 0;
                    ...
                    attacking = stateInfo.IsName("Witcher_Attack");
    ...
    public void Attacked()
    {
        if (hp > 0)
        {
            ...
            if (--hp == 0)
            {
                ...
                SoundManagerScript.PlaySound("Hit3");
